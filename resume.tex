    ...
    \resumeSubheading
      ...
      {Software Engineer, Intern}{Jan 2024 | Aug 2024}
        \resumeItemListStart
            ...
            \resumeItem{Led refactoring efforts for the codebase of Export Platform, an internal service that supports bulk export of data from RPC endpoints. Optimized data fetching to cut latency of exports by up 50\%.}
...
\resumeSubHeadingListStart
  \small{\item{
      ...
      \textbf{Technologies:}{ Git, Protobuf, Thrift, MySQL, MongoDB, React, Google Cloud Platforms} \\ \vspace{3pt}
  }}
\resumeSubHeadingListEnd
...
\section{Misc}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Work Authorization:}{ Singaporean Citizen; Eligible for High Potential Individual visa as a graduate of National University of Singapore.} \\ \vspace{3pt}
    }}
  \resumeSubHeadingListEnd
